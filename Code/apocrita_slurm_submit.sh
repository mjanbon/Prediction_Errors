#!/bin/bash
#SBATCH -o /data/SBBS-PIDProject/Maxime/Logs/CoI/CoI_active_sleep_%A_%a.log
#SBATCH --mem-per-cpu=16G    # Request 16G per cpu
#SBATCH -t 239:00:00         # Request 239 hours runtime
#SBATCH -n 1                # Request 1 core
#SBATCH -a 1-1800           # Array Job-ID 1-1800 Doing all other flies
...
matlab -nodisplay -nosplash -r "max_main(${SLURM_ARRAY_TASK_ID}); quit"